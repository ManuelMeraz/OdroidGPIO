...
gpio::serial::Port::Port(std::string device_name,
                         uint32_t baud_rate,
...
void gpio::serial::Port::write(const std::string& message)
{
