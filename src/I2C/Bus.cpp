...
gpio::I2C::Bus::Bus(uint8_t device_number, uint16_t sda_pin_number, uint16_t scl_pin_number) :
...
auto gpio::I2C::Bus::read_8_bits(uint32_t register_address) const -> uint8_t
{
   return gpio::I2C::read_8_bits(m_file_descriptor, register_address);
}

[[maybe_unused]] auto gpio::I2C::Bus::read_16_bits(uint32_t register_address) const -> uint16_t
{
   return gpio::I2C::read_16_bits(m_file_descriptor, register_address);
}

void gpio::I2C::Bus::write_8_bits(uint32_t register_address, uint8_t data)
{
   gpio::I2C::write_8_bits(m_file_descriptor, data, register_address);
}

[[maybe_unused]] void gpio::I2C::Bus::write_16_bits(uint16_t data, uint32_t register_address)
{
